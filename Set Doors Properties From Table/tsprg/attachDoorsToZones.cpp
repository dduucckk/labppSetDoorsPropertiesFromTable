...
int Zoom()
{
	...
	ac_request("Automate","ZoomToElements",7,1); // [17:41, 11/11/2021] Иван: нет, тут не надо скобок, тут достаточно скобок. не понимаю, почему он ругается
// [17:54, 11/11/2021] Юрий Цепов: мой косяк
// [17:54, 11/11/2021] Юрий Цепов: я сделал возможным здесь не писать отступ
// [17:55, 11/11/2021] Иван: что за отступ?
// [17:57, 11/11/2021] Юрий Цепов: он позиционирует на элементе и немного я сделал чтобы отодвигал экран
// [17:57, 11/11/2021] Юрий Цепов: можно сейчас чтобы не париться - доставить после семерки ,1
// [17:57, 11/11/2021] Юрий Цепов: т.е. еще один параметр - смещение равное 1
	return 0;
}
